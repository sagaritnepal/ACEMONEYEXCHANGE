...
const Logo = () => (
  <a href="#home" className="flex items-center group min-w-0">
    <img src="/ace-logo.svg" alt="Ace Money Exchange" className="h-20 sm:h-24 w-auto flex-shrink-0" />
  </a>
);
...
const Header = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-[#0B1220]/95 backdrop-blur-md shadow-lg' : 'bg-transparent'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 h-24 sm:h-28 flex items-center justify-between gap-3">
        <Logo />
